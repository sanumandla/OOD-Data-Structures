...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String characters = getStringFromFile(textfile, numToCheck);
						
			long startTime = System.nanoTime();
			for (int i = 0; i < trials; i++ ) {
				BasicDocument basicDocument = new BasicDocument(characters);
				basicDocument.getFleschScore();
			}
			long endTime = System.nanoTime();			
			long diff1 = (endTime - startTime) / 10^9;

			System.out.print(diff1 + "\t");
			
			long startTime1 = System.nanoTime();
			for (int i = 0; i < trials; i++ ) {
				EfficientDocument efficientDocument = new EfficientDocument(characters);
				efficientDocument.getFleschScore();
			}
			long endTime1 = System.nanoTime();			
			long diff2 = (endTime1 - startTime1) / 10^9;
